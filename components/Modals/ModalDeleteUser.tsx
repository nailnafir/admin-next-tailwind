...
export default function ModalDeleteUser(props: ModalDeleteUserProps) {
  const { isModalOpen, onDelete, onClose } = props;
      ...
      <div className="relative w-full h-full max-w-md px-4 md:h-auto">
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
          ...
          <div className="p-6 pt-0 text-center">
            ...
            <button
              onClick={onClose}
              className="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 border border-gray-300 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
              data-modal-toggle="delete-user-modal"
            >
              No, cancel
            </button>
