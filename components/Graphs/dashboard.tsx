...
export default function Dashboard() {
  const [isFilterStatusOpen, setFilterStatusOpen] = useState(false);

  function filterByStatusHandler() {
    setFilterStatusOpen(!isFilterStatusOpen);
  }
          ...
          <form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
            ...
            <article className="mb-5">
              ...
              <p className="mb-2 text-gray-900 dark:text-white">
                ...
                can&apos;t wait to start working on this new project with you
                guys. But first things first, I&apos;am waiting for the offer
                and pitch deck from you. It would be great to get it by the end
                o the month.
              </p>
