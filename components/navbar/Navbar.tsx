...
interface NavbarProps {
  ...
  onClickToggleNavbar: React.MouseEventHandler<SVGSVGElement>;
}

export default function Navbar(props: NavbarProps) {
  const { isSidebarOpen, onClickToggleNavbar } = props;
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4 p-4">
                <ApplicationMenuItem title="Sales">
                  <svg
                ...
                <ApplicationMenuItem title="Users">
                  <svg
                    className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <ApplicationMenuItem title="Inbox">
                  <svg
                    className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <ApplicationMenuItem title="Profile">
                  <svg
                    className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <ApplicationMenuItem title="Settings">
                  <svg
                    className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <ApplicationMenuItem title="Products">
                  <svg
                    className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <ApplicationMenuItem title="Pricing">
                  <svg
                    className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <ApplicationMenuItem title="Billing">
                  <svg
                    className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <ApplicationMenuItem title="Sign Out">
                  <svg
                    className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400"
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="flex items-center ml-3">
              ...
              >
                ...
                <ul className="py-1" role="none">
                  <ProfileMenuItem href="#" title="Dashboard" />
                  <ProfileMenuItem href="#" title="Settings" />
                  <ProfileMenuItem href="#" title="Earnings" />
                  <ProfileMenuItem href="#" title="Sign Out" />
                </ul>
              </div>
            </div>
          </div>
