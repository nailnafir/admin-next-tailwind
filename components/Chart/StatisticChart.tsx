...
export default function StatisticMonth() {
  ...
  const [isLastRangeOpen, setLastRangeOpen] = useState(false);

  function lastRangeHandler() {
    setLastRangeOpen(!isLastRangeOpen);
  }

  function indexTabHandler() {
    setIndexTab(indexTab === 0 ? 1 : 0);
  }
    ...
    <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
      ...
      >
        <div className="p-3 space-y-2">
          ...
          <a
            href="#"
            className="flex items-center font-medium text-orange-500 hover:text-orange-700"
          >
            Read more{" "}
            <svg
      ...
      <div className="sm:hidden">
        ...
        <select
          id="tabs"
          className="bg-gray-50 border-0 border-b border-gray-200 text-gray-900 text-sm rounded-t-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500"
        >
      ...
      >
        <div
          className={`${indexTab === 0 ? "" : "hidden"} pt-4`}
          id="faq"
          role="tabpanel"
      ...
      <div className="flex items-center justify-between pt-3 mt-5 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
        <div>
          ...
          <div
            className={`${
              isLastRangeOpen ? "absolute" : "hidden"
        ...
        <div className="flex-shrink-0">
          <a
            href="#"
            className="inline-flex items-center p-2 text-xs font-medium uppercase rounded-lg text-orange-500 sm:text-sm hover:bg-gray-100 dark:hover:bg-gray-700"
          >
            Full Report
            <svg
              className="w-4 h-4 ml-1"
